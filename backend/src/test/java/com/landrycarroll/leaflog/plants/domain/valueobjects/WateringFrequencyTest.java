...
public class WateringFrequencyTest {
    ...
    public void shouldThrowExceptionWhenValueIsNegative() {
        ...
        assertEquals("Watering Frequency must be greater than or equal to 0", ex.getMessage());
    }
    ...
    public void shouldThrowExceptionWhenValueExceedsMaximum() {
        ...
        assertEquals("Watering Frequency must be less than or equal to " + MAXIMUM_VALUE, ex.getMessage());
    }
